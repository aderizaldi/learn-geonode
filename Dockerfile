...
RUN mkdir -p /usr/src/learn_geonode
...
COPY src /usr/src/learn_geonode/
WORKDIR /usr/src/learn_geonode
...
RUN chmod +x /usr/src/learn_geonode/tasks.py \
    && chmod +x /usr/src/learn_geonode/entrypoint.sh
...
# ENTRYPOINT /usr/src/learn_geonode/entrypoint.sh
